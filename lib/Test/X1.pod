...
subclass module, L<My/Test/X1.pm>, would look like:
...
Name the test.  See C</Naming> for details.
...
Name the test block.  See C</Naming> for details.
...
A (likely outdated) tarball copy of the module might be available from
<http://wakaba.github.com/packages/perl/#Test-X1>.
